...
<div id="<?php echo $tab['id']; ?>" class="w3-container tab <?php echo $tab['class']; ?>" style="height: auto; border-style: solid; border-radius: 50px; padding-bottom: 2%; margin-bottom: 2%; display: none;">
	<!-- Tab title -->
