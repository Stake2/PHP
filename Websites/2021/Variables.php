...
$website_title_text = Language_Item_Definer("My", "Meu")." ".$website_info["english_title"];
$website_title_header = $website_title_text.": ".$icons_array["calendar"];
$website_link = $website_info["link"];
