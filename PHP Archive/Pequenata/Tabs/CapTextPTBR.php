...
while ($capnum1 <= $chapters) {
	...
	if ($capnum1 == $chapters) {
		echo '<h2 class="'.$textstyle.'"><br />'.$reading.'<b>'.$capbtntext.' '.$capnum1.' - '.$titles[$capnum4].' <span class="w3-text-yellow">[Novo!]</span>'.'</b><br /></h2>';
		$capnum4++;
		$capnum5++;
	} 
	...
	if ($capnum1 == $chapters) {
		echo '<div style="text-align:center;"><span class="'.$textstyle.'"><br />'.$reading.'<b>'.$capbtntext.' '.$capnum1.' - '.$titles[$capnum7].' <span class="w3-text-yellow">[Novo!]</span>'.'</b><br /></span></div>';
		$capnum7++;
		$capnum8++;
	} 
