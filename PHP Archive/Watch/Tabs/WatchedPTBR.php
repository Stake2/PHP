<a name="<?php echo $watchedptbr; ?>"></a>
<div id="<?php echo $watchedptbr; ?>" class="city" style="display:none;">
<div class="mobileHide"><br /><br /><br /></div>
<center>
<?php echo $margin2; ?><?php echo "\n"; ?>
<br />
<?php echo $everybtnwatchedptbry1; ?>
<<?php echo $n3; ?> class="w3-text-blue w3-black"><hr class="<?php echo $sitehr; ?>" /><br /><?php echo $watchedtextptbr; ?> <?php echo $ano; ?>: <span class="w3-text-yellow">[<?php echo $watchednumb2020; ?>]</span><br /><br /></<?php echo $n3; ?>><hr class="<?php echo $sitehr; ?>" />
