<a name="<?php echo $towatchptbr; ?>"></a><?php echo "\n"; ?>
<div id="<?php echo $towatchptbr; ?>" class="city <?php echo $mobile0; ?>"><?php echo "\n"; ?>
<div class="mobileHide"><br /><br /><br /></div><?php echo "\n"; ?>
<?php echo $margin2; ?><?php echo "\n"; ?>
<br /><?php echo "\n"; ?>
<<?php echo $n3; ?> class="w3-text-blue w3-black"><br /><?php echo $towatchtextptbr; ?>: <span class="w3-text-yellow">[<?php echo $towatchnumb; ?>]</span><br /><br /></<?php echo $n3; ?>><hr class="<?php echo $sitehr; ?>" />
<br />
<?php
