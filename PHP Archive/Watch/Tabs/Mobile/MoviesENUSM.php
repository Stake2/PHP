<a name="<?php echo $movieenusm; ?>"></a>
<div id="<?php echo $movieenusm; ?>" class="city <?php echo $mobile1; ?>" style="display:none;"><?php echo "\n"; ?>
<div class="mobileHide"><br /><br /><br /></div><?php echo "\n"; ?>
<?php echo $margin2; ?><?php echo "\n"; ?>
<br /><?php echo "\n"; ?>
<?php echo $margin3; ?><?php echo "\n"; ?>
<?php echo $everybtnwatchedenusy2m; ?>
<?php echo $divc; ?><?php echo "\n"; ?>
<div class="w3-black"><?php echo "\n"; ?>
<<?php echo $m3; ?> class="w3-text-blue w3-black"><hr class="<?php echo $sitehr; ?>" /><br /><?php echo $movietextenus; ?>: <span class="w3-text-yellow">[<?php echo $moviesnumb; ?>]</span><br /><br /><hr class="<?php echo $sitehr; ?>" /></<?php echo $m3; ?>><?php echo "\n"; ?>
