<a name="<?php echo $e2018ptbrm; ?>"></a>
<div id="<?php echo $e2018ptbrm; ?>" class="city" style="display:none;">
...
<<?php echo $m3; ?> class="w3-text-blue w3-black"><hr class="<?php echo $sitehr; ?>" /><br /><?php echo $watchedtextptbr; ?> <?php echo $anos[0]; ?>: <span class="w3-text-yellow">[<?php echo $watchednumb2018; ?>]</span><br /><br /><hr class="<?php echo $sitehr; ?>" /></<?php echo $m3; ?>><?php echo "\n"; ?>
<?php echo $margin3; ?><?php echo "\n"; ?>
<?php echo $everyanosptbr2018ym; ?><?php echo "\n"; ?>
<?php echo $divc; ?><?php echo "\n"; ?>
