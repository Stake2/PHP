...
"<center>"."\n".
'<img src="'.$website_info["image_link"].'" width="'.$website_image_size_computer.'%" class="w3-center '.$border_style_classes." ".$computer_variable.' w3-center" style="'.$rounded_border_style_to_use.'" />'."\n".
"</center>"."\n";

$main_website_image_mobile = "<!-- Mobile website image -->"."\n".
"<center>"."\n".
'<img src="'.$website_info["image_link"].'" width="'.$website_image_size_mobile.'%" class="'.$border_style_classes." ".$mobile_variable.' w3-center" style="'.$rounded_border_style_to_use.'" />'."\n"."</center>"."\n";
...
if ($website_function_settings["image_link_button"] == True) {
	...
	'<button class="w3-btn '.$first_button_style.'" '.$roundedborderstyle.' onclick="window.open('."'".$website_info["image_link"]."'".')">'."\n".
