...
#if ($website_name != $website_watch_history and $website_name != $website_the_life_of_littletato and $website_name != $website_the_story_of_the_bulkan_brothers and $website_name != $website_things_i_do and $website != $website_diario and $website_name == $website_spaceliving and $selected_website == $website_desert_island) {
