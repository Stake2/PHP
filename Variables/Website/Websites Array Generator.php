...
$i = 0;
foreach ($website_titles as $value) {
	$folder = $folders["mega"]["php"]["websites"]["root"].Remove_Non_File_Characters($value)."/";
...
$i = 0;
foreach ($website_titles as $value) {
	$website_information["php_folder"] = $website_php_folders[$value];

	$variables_file = $website_information["php_folder"]."Variables.php";
	$website_style_file = $website_information["php_folder"]."Style.php";
