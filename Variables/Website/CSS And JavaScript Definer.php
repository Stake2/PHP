...
if ($website_function_settings["is_prototype"] == False and $website_settings["custom_layout"] == False and strpos($_SERVER["REQUEST_URI"], "Select_Website") == False) {
	$website_css_file_name = Remove_Non_File_Characters($website_information["english_title"]);

	if (isset($website_information["custom_css_file"]) == True) {
		$website_css_file_name = $website_information["custom_css_file"];
	}
