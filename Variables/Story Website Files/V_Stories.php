...
foreach ($story_website_names_text as $story_website_name) {
	...
	$story_website_links[$local_english_story_name] = $main_website_url.$local_english_story_name."/";
...
foreach ($english_story_names as $local_story_name) {
	...
	if ($local_story_name != $local_portuguese_story_name) {
		$local_story_cover .= $website_info["full_language"]."/";
	}
...
$chapter_in_language = $chapters_text." ".$in_text." ".$website_info["full_language"];
