...
$cover_folder = $website_media_images_story_covers.$website_info["english_title"]."/";
$local_cover_folder = $mega_stories_folder.$website_info["english_title"]."/Covers/";
...
$website_info["full_language"] = $small_languages_array[$language_number];

$story_chapter_files_folder_language = $story_chapter_files_folder;

if ($story_website_settings["has_custom_story_folder"] == False) {
	$story_chapter_files_folder_language .= $website_info["full_language"]."/";
}
...
if ($story_website_settings["has_story_covers"] == True) {
	...
	if (isset($website_info["website_folder_name"]) == False) {
		$story_book_cover_folder .= $website_info["full_language"]."/";	
	}

	$local_story_chapter_covers_folder .= $website_info["full_language"]."/";
	$story_chapter_covers_folder .= $website_info["full_language"]."/";
}
