...
$current_form_name = $website_information["english_title"]."_Read";
...
echo '<form name="'.$website_information["english_title"].'-comment" method="POST" data-netlify="True" '.$roundedborderstyle.'>'."\n".
$margin2."\n";
