...
echo $margin3."\n";
echo '<a href="#music"><button class="w3-btn w3-yellow '.$cssbtn1.'" '.$roundedborderstyle.' onclick="openCity('."'".$website_tab_codes_computer[11]."')".'">'.$website_tab_titles_computer[11].'</button></a>'."\n";
echo '<a href="#playlist"><button class="w3-btn w3-grey '.$cssbtn1.'" '.$roundedborderstyle.' onclick="openCity('."'".$website_tab_codes_computer[12]."')".'">'.$website_tab_titles_computer[12].'</button></a>'."\n";
echo '<br /><br />'."\n";
echo $div_close."\n";
...
echo '<a name="musicm"></a>'."\n";
echo $margin3."\n";
echo '<a href="#musicm"><button class="w3-btn w3-yellow '.$cssbtn1.'" '.$roundedborderstyle.' onclick="openCity('."'".$website_tab_codes_mobile[11]."')".'">'.$website_tab_titles_mobile[11].'</button></a>'."\n";
echo '<a href="#playlistm"><button class="w3-btn w3-grey '.$cssbtn1.'" '.$roundedborderstyle.' onclick="openCity('."'".$website_tab_codes_mobile[12]."')".'">'.$website_tab_titles_mobile[12].'</button></a>'."\n";
echo '<br /><br />'."\n";
echo $div_close."\n";
...
while ($i <= $musicnumb) {
	...
	echo '<div class="'.$textstyle2.'" style="border-color:'.$bordercolor.';border-style:solid;'.$rounded_border_style_2.'">'."\n";
	echo $div_zoom_animation.'<p></p><br />'.'<b>'.$musictitles[$i].':</b>'.$div_close.'<br /><p></p>'.'<hr class="'.$sitehr3.'" style="border-width:3px;border-color:'.$color.';border-style:solid;" />'."\n";
