...
echo '<p style="margin-bottom:1%;margin-left:3%;margin-right:3%;">'.$tabdescriptions[9].$pc."\n";
echo $div_close."\n";
echo $div_close."\n";
echo $div_close."\n";
...
echo '<div class="'.$textstyle2.'" style="border-color:'.$bordercolor.';border-style:solid;'.$rounded_border_style_2.'">';
echo $margin."\n";
echo '<p style="margin-bottom:3%;">'.'<b>'.$tabsubdescs[9].': '.'</b>'.$pc."\n";

echo $socialmediabtns[6]."\n";
echo $socialmediabtns[7]."\n";

echo '<button class="w3-btn w3-white '.$cssbtn1.'" '.$roundedborderstyle.' onclick="window.open('."'".$links[2]."')".'">'.$gamestxt.'</button>'.'<br /><br />'."\n";
...
echo $margin."\n";
echo '<p style="margin-top:2%;">'.'<b>'.$tabsubdescs[0].': '.'</b>'.$pc."\n";
echo '<p style="margin-bottom:7%;">'.$tabdescriptions[9].$pc."\n";
echo $div_close."\n";
echo $div_close."\n";
echo $div_close."\n";
...
echo '<div class="'.$textstyle2.'" style="border-color:'.$bordercolor.';border-style:solid;'.$rounded_border_style_2.'">';
echo $margin."\n";
echo '<p style="margin-bottom:7%;">'.'<b>'.$tabsubdescs[9].': '.'</b>'.$pc."\n";

echo $socialmediabtns[6]."\n";
echo $socialmediabtns[7]."\n";

echo '<button class="w3-btn w3-white '.$cssbtn1.'" '.$roundedborderstyle.' width="10%" onclick="window.open('."'".$links[2]."')".'"><h5 width="10%">'.$gamestxt.'</h5></button>'.'<br /><br />'."\n";
