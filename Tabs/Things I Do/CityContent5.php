...
echo '<p style="margin-bottom:1%;margin-left:3%;margin-right:3%;">'.$tabdescriptions[3].$pc."\n";
echo $div_close."\n";
...
echo $margin."\n";
echo '<p style="margin-bottom:3%;">'.'<b>'.$tabsubdescs[3].': '.'</b>'.$pc."\n";
echo $div_close."\n";
...
echo $bluespan.'<a class="link" href="'.$links[0].'">'.$links[0].'</a>'.$spanc;
...
echo $margin."\n";
echo '<p style="margin-top:2%;">'.'<b>'.$tabsubdescs[0].': '.'</b>'.$pc."\n";
echo '<p style="margin-bottom:7%;">'.$tabdescriptions[3].$pc."\n";
echo $div_close."\n";
...
echo $margin."\n";
echo '<p style="margin-bottom:7%;">'.'<b>'.$tabsubdescs[3].': '.'</b>'.$pc."\n";
echo $div_close."\n";
