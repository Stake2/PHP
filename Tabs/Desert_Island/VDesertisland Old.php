...
#Website descriptions
$website_descriptions_array = array(
'Website about a new story that is coming, made by stake2.',
'Website sobre uma nova história que está chegando, feito por stake2.',
);
...
if ($website_language == $geral_language) {
	...
	$website_title_header = $enus_title.': '.$icons[4].' '.$icons[22];
