...
$website_information["website_folder_name"] = "My Little Pony/".$english_friendship_is_magic_text;

$website_images_folder = $website_media_images_website_images.$website_information["website_folder_name"]."/";
...
$website_audio_folder = $website_media_website_audio.$website_information["website_folder_name"]."/";

# Website image link and image size
$website_information["image_format"] = "png";
$website_information["image_link"] = $website_media_images_website_icons.$website_information["website_folder_name"].".".$website_information["image_format"];
...
$website_information["language_title"] = $website_information["language_title"];
$website_information["language_title_with_icon"] = $my_little_pony_name_colored.": ".$icons_array["open book"]." ".$icons_array["heart"];

$website_information["meta_description"] = $website_descriptions[$language_number];
$website_information["header_description"] = $website_header_descriptions[$language_number];
