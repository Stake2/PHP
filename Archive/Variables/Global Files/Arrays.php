...
foreach ($websites as $local_website_name) {
	...
	$local_website_link = $website["url"];
	$local_website_folder_path = "";

	if ($local_website_name == "SpaceLiving") {
		$local_website_link .= "New World/";
		$local_website_folder_path .= "New World/";
	}
	...
	$website_folders[$key] = $folders["mega"]["websites"]["root"].$local_website_folder_path;
