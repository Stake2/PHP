...
<!-- Website header -->
<div class="w3-container w3-animate-zoom <?php echo $website['style']['header']; ?>" style="padding: 20px; width: 45%">
	<!-- Website title -->
	<h3 class="text_size <?php echo $website['style']['text']['secondary_theme']['normal']; ?>">
