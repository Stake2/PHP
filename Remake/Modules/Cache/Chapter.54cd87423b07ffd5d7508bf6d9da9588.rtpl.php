...
<div id="<?php echo $chapter_tab['id']; ?>" class="tab <?php echo $chapter_tab['class']; ?>" style="height: auto; border-style: solid; border-radius: 50px; padding-bottom: 2%; margin-bottom: 2%; display: none;">
	<!-- Chapter title top -->
	<h2 class="text_size">
